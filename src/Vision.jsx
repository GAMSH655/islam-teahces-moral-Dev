        ...
        <div>
             <div className="Vision">
                ...
                <div className="visionSideTExt">
                    ...
                    Sit quasi beatae amet perspiciatis explicabo magnam, quae aperiam ut quia deserunt. Dicta alias assumenda velit et error maxime necessitatibus saepe fugit. Ea labore sequi quisquam consectetur architecto ducimus nihil.
                    Aquibusdam. Magni nam quibusdam maiores totam impedit in vitae pariatur dicta.</p>
                </div>
             </div>
        </div>
     )
